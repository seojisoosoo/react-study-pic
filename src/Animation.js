...
const Animation = () => {
  ...
  //   let second = document.querySelector("#second-pic");

  window.addEventListener("scroll", function () {
    let value = window.scrollY;
    console.log(value);
    if (value > 0) {
      document.querySelector("#first-pic").style.animation =
        "first 2s ease-out";
      //   document.querySelector("#second-pic").style.right = "-200px";
    }
    if (value > 100) {
      document.querySelector("#second-pic").style.animation =
        "second 2s ease-out";
    }
  });
